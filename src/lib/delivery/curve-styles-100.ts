...
export const CURVE_100_LIST: CurveStyleConfig[] = [
  // ── 1 to 10 ──
  {
    ...
    warmup: 6, peak: 12, icon: "🐢", category: "Whop Clips",
  ...
  },
  {
    ...
    warmup: 2, peak: 4, icon: "⚡", category: "Clipster",
  ...
  },
  {
    ...
    warmup: 10, peak: 18, icon: "🛫", category: "Content Rewards",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "🪜", category: "Clipstake",
  ...
  },
  {
    ...
    warmup: 4, peak: 8, icon: "🚀", category: "Crosswave",
  ...
  },
  {
    ...
    warmup: 4, peak: 8, icon: "🌅", category: "Picksart",
  ...
  },
  {
    ...
    warmup: 6, peak: 14, icon: "🪝", category: "Pearpop",
  ...
  },
  {
    ...
    warmup: 1, peak: 3, icon: "↩️", category: "JoinBrands",
  ...
  },
  {
    ...
    warmup: 1, peak: 4, icon: "🪵", category: "Trend.io",
  ...
  },
  {
    ...
    warmup: 1, peak: 3, icon: "💨", category: "Insense",
  ...
  // ── 11 to 20 ──
  {
    ...
    warmup: 3, peak: 8, icon: "🐚", category: "Whop Clips",
  ...
  },
  {
    ...
    warmup: 1, peak: 4, icon: "🪜", category: "Clipster",
  ...
  },
  {
    ...
    warmup: 2, peak: 6, icon: "🪜", category: "Content Rewards",
  ...
  },
  {
    ...
    warmup: 3, peak: 6, icon: "🎲", category: "Clipstake",
  ...
  },
  {
    ...
    warmup: 2, peak: 5, icon: "🪚", category: "Crosswave",
  ...
  },
  {
    ...
    warmup: 1, peak: 2, icon: "🔥", category: "Picksart",
  ...
  },
  {
    ...
    warmup: 4, peak: 8, icon: "🌊", category: "Pearpop",
  ...
  },
  {
    ...
    warmup: 6, peak: 10, icon: "📍", category: "JoinBrands",
  ...
  },
  {
    ...
    warmup: 5, peak: 10, icon: "💳", category: "Trend.io",
  ...
  },
  {
    ...
    warmup: 2, peak: 16, icon: "🗄️", category: "Insense",
  ...
  // ── 21 to 30 ──
  {
    ...
    warmup: 2, peak: 5, icon: "🌅", category: "Whop Clips",
    stroke: "#ff00aa", glow: "rgba(255, 0, 170, 0.45)", stop: "#b8007a",
  ...
  },
  {
    ...
    warmup: 6, peak: 12, icon: "🔔", category: "Clipster",
    stroke: "#00ff88", glow: "rgba(0, 255, 136, 0.45)", stop: "#00b862",
  ...
  },
  {
    ...
    warmup: 4, peak: 8, icon: "🎨", category: "Clipstake",
    stroke: "#ff0055", glow: "rgba(255, 0, 85, 0.45)", stop: "#c0003c",
  ...
  },
  {
    ...
    warmup: 3, peak: 9, icon: "🏔️", category: "Crosswave",
    stroke: "#39ff14", glow: "rgba(57, 255, 20, 0.45)", stop: "#24b30c",
  ...
  },
  {
    ...
    warmup: 3, peak: 10, icon: "⚡", category: "Pearpop",
    stroke: "#b800ff", glow: "rgba(184, 0, 255, 0.45)", stop: "#8200b8",
  ...
  },
  {
    ...
    warmup: 8, peak: 14, icon: "📶", category: "JoinBrands",
    stroke: "#0088ff", glow: "rgba(0, 136, 255, 0.45)", stop: "#005bb8",
  ...
  },
  {
    ...
    warmup: 1, peak: 12, icon: "🎚️", category: "Trend.io",
    stroke: "#ffee00", glow: "rgba(255, 238, 0, 0.45)", stop: "#b8ab00",
  ...
  },
  {
    ...
    warmup: 3, peak: 15, icon: "🪦", category: "Insense",
    stroke: "#ff007f", glow: "rgba(255, 0, 127, 0.45)", stop: "#b8005b",
  ...
  // ── 31 to 40 ──
  {
    ...
    warmup: 2, peak: 12, icon: "⭐", category: "Whop Clips",
    stroke: "#00ffcc", glow: "rgba(0, 255, 204, 0.45)", stop: "#00b893",
  ...
  },
  {
    ...
    warmup: 1, peak: 2, icon: "⛷️", category: "Content Rewards",
    stroke: "#ff4500", glow: "rgba(255, 69, 0, 0.45)", stop: "#b83100",
  ...
  },
  {
    ...
    warmup: 2, peak: 8, icon: "🥀", category: "Clipstake",
    stroke: "#7fff00", glow: "rgba(127, 255, 0, 0.45)", stop: "#5bb800",
  ...
  },
  {
    ...
    warmup: 2, peak: 6, icon: "🪜", category: "Crosswave",
    stroke: "#ff1493", glow: "rgba(255, 20, 147, 0.45)", stop: "#b80f6a",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🪂", category: "Picksart",
  ...
  },
  {
    ...
    warmup: 2, peak: 14, icon: "🧗", category: "Pearpop",
    stroke: "#ffd700", glow: "rgba(255, 215, 0, 0.45)", stop: "#b89b00",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🪃", category: "JoinBrands",
  ...
  },
  {
    ...
    warmup: 4, peak: 14, icon: "v", category: "Trend.io",
    stroke: "#00ced1", glow: "rgba(0, 206, 209, 0.45)", stop: "#009496",
  ...
  },
  {
    ...
    warmup: 5, peak: 15, icon: "u", category: "Insense",
    stroke: "#ff0055", glow: "rgba(255, 0, 85, 0.45)", stop: "#c0003c",
    evalCurve: (t, p) => Math.pow(p - 0.5, 2) * 3 + 0.2
  },
  ...
  // ── 41 to 50 ──
  {
    ...
    warmup: 4, peak: 10, icon: "w", category: "Whop Clips",
    stroke: "#00ffff", glow: "rgba(0, 255, 255, 0.45)", stop: "#00b8b8",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "m", category: "Clipster",
    stroke: "#39ff14", glow: "rgba(57, 255, 20, 0.45)", stop: "#24b30c",
  ...
  },
  {
    ...
    warmup: 3, peak: 12, icon: "n", category: "Content Rewards",
    stroke: "#ffaa00", glow: "rgba(255, 170, 0, 0.45)", stop: "#b87a00",
  ...
  },
  {
    ...
    warmup: 3, peak: 12, icon: "M", category: "Clipstake",
    stroke: "#b800ff", glow: "rgba(184, 0, 255, 0.45)", stop: "#8200b8",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "z", category: "Crosswave",
    stroke: "#ff00aa", glow: "rgba(255, 0, 170, 0.45)", stop: "#b8007a",
  ...
  },
  {
    ...
    warmup: 2, peak: 8, icon: "↘️", category: "JoinBrands",
    stroke: "#0088ff", glow: "rgba(0, 136, 255, 0.45)", stop: "#005bb8",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "📶", category: "Trend.io",
    stroke: "#ffee00", glow: "rgba(255, 238, 0, 0.45)", stop: "#b8ab00",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🌀", category: "Insense",
    stroke: "#ff007f", glow: "rgba(255, 0, 127, 0.45)", stop: "#b8005b",
  ...
  // ── 51 to 60 ──
  {
    ...
    warmup: 4, peak: 14, icon: "📈", category: "Whop Clips",
    stroke: "#00ffcc", glow: "rgba(0, 255, 204, 0.45)", stop: "#00b893",
  ...
  },
  {
    ...
    warmup: 6, peak: 14, icon: "🚀", category: "Picksart",
    stroke: "#1e90ff", glow: "rgba(30, 144, 255, 0.45)", stop: "#1268b8",
  ...
  },
  {
    ...
    warmup: 1, peak: 4, icon: "🪂", category: "Pearpop",
    stroke: "#ffd700", glow: "rgba(255, 215, 0, 0.45)", stop: "#b89b00",
  ...
  },
  {
    ...
    warmup: 6, peak: 16, icon: "🧮", category: "JoinBrands",
    stroke: "#ff6347", glow: "rgba(255, 99, 71, 0.45)", stop: "#b84531",
  ...
  // ── 61 to 70 ──
  {
    ...
    warmup: 4, peak: 12, icon: "〰️", category: "Whop Clips",
    stroke: "#00ffff", glow: "rgba(0, 255, 255, 0.45)", stop: "#00b8b8",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🎢", category: "Clipster",
    stroke: "#39ff14", glow: "rgba(57, 255, 20, 0.45)", stop: "#24b30c",
  ...
  },
  {
    ...
    warmup: 6, peak: 16, icon: "📅", category: "Content Rewards",
    stroke: "#ffaa00", glow: "rgba(255, 170, 0, 0.45)", stop: "#b87a00",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "📈", category: "Clipstake",
    stroke: "#b800ff", glow: "rgba(184, 0, 255, 0.45)", stop: "#8200b8",
  ...
  },
  {
    ...
    warmup: 4, peak: 14, icon: "↗️", category: "Crosswave",
    stroke: "#ff00aa", glow: "rgba(255, 0, 170, 0.45)", stop: "#b8007a",
  ...
  },
  {
    ...
    warmup: 2, peak: 6, icon: "↘️", category: "Picksart",
    stroke: "#00ff88", glow: "rgba(0, 255, 136, 0.45)", stop: "#00b862",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🛣️", category: "Pearpop",
    stroke: "#ff3300", glow: "rgba(255, 51, 0, 0.45)", stop: "#b82400",
  ...
  },
  {
    ...
    warmup: 2, peak: 8, icon: "🔻", category: "JoinBrands",
    stroke: "#0088ff", glow: "rgba(0, 136, 255, 0.45)", stop: "#005bb8",
  ...
  },
  {
    ...
    warmup: 8, peak: 16, icon: "💥", category: "Trend.io",
    stroke: "#ffee00", glow: "rgba(255, 238, 0, 0.45)", stop: "#b8ab00",
  ...
  },
  {
    ...
    warmup: 2, peak: 8, icon: "⚡", category: "Insense",
    stroke: "#ff007f", glow: "rgba(255, 0, 127, 0.45)", stop: "#b8005b",
  ...
  // ── 71 to 80 ──
  {
    ...
    warmup: 6, peak: 14, icon: "🛡️", category: "Whop Clips",
    stroke: "#00ffcc", glow: "rgba(0, 255, 204, 0.45)", stop: "#00b893",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "⚔️", category: "Clipster",
    stroke: "#8a2be2", glow: "rgba(138, 43, 226, 0.45)", stop: "#5e1da6",
  ...
  },
  {
    ...
    warmup: 2, peak: 8, icon: "🏀", category: "Content Rewards",
    stroke: "#ff4500", glow: "rgba(255, 69, 0, 0.45)", stop: "#b83100",
  ...
  },
  {
    ...
    warmup: 2, peak: 10, icon: "🏓", category: "Clipstake",
    stroke: "#7fff00", glow: "rgba(127, 255, 0, 0.45)", stop: "#5bb800",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "🌩️", category: "Crosswave",
    stroke: "#ff1493", glow: "rgba(255, 20, 147, 0.45)", stop: "#b80f6a",
  ...
  },
  {
    ...
    warmup: 4, peak: 16, icon: "🍃", category: "Picksart",
    stroke: "#1e90ff", glow: "rgba(30, 144, 255, 0.45)", stop: "#1268b8",
  ...
  },
  {
    ...
    warmup: 6, peak: 16, icon: "📦", category: "Pearpop",
    stroke: "#ffd700", glow: "rgba(255, 215, 0, 0.45)", stop: "#b89b00",
  ...
  },
  {
    ...
    warmup: 6, peak: 14, icon: "📐", category: "JoinBrands",
    stroke: "#ff6347", glow: "rgba(255, 99, 71, 0.45)", stop: "#b84531",
  ...
  },
  {
    ...
    warmup: 2, peak: 6, icon: "🚩", category: "Insense",
    stroke: "#ff0055", glow: "rgba(255, 0, 85, 0.45)", stop: "#c0003c",
  ...
  // ── 81 to 90 ──
  {
    ...
    warmup: 6, peak: 14, icon: "☕", category: "Whop Clips",
    stroke: "#00ffff", glow: "rgba(0, 255, 255, 0.45)", stop: "#00b8b8",
  ...
  },
  {
    ...
    warmup: 6, peak: 16, icon: "🥣", category: "Clipster",
    stroke: "#39ff14", glow: "rgba(57, 255, 20, 0.45)", stop: "#24b30c",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "☂️", category: "Content Rewards",
    stroke: "#ffaa00", glow: "rgba(255, 170, 0, 0.45)", stop: "#b87a00",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "🔻", category: "Crosswave",
    stroke: "#ff00aa", glow: "rgba(255, 0, 170, 0.45)", stop: "#b8007a",
  ...
  },
  {
    ...
    warmup: 5, peak: 12, icon: "⚡", category: "Picksart",
    stroke: "#00ff88", glow: "rgba(0, 255, 136, 0.45)", stop: "#00b862",
  ...
  },
  {
    ...
    warmup: 2, peak: 6, icon: "🏁", category: "Pearpop",
    stroke: "#ff3300", glow: "rgba(255, 51, 0, 0.45)", stop: "#b82400",
  ...
  },
  {
    ...
    warmup: 5, peak: 12, icon: "💎", category: "Trend.io",
    stroke: "#ffee00", glow: "rgba(255, 238, 0, 0.45)", stop: "#b8ab00",
  ...
  },
  {
    ...
    warmup: 5, peak: 14, icon: "💠", category: "Insense",
    stroke: "#ff007f", glow: "rgba(255, 0, 127, 0.45)", stop: "#b8005b",
  ...
  // ── 91 to 100 ──
  {
    ...
    warmup: 4, peak: 10, icon: "👤", category: "Whop Clips",
    stroke: "#00ffcc", glow: "rgba(0, 255, 204, 0.45)", stop: "#00b893",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "📢", category: "Content Rewards",
    stroke: "#ff4500", glow: "rgba(255, 69, 0, 0.45)", stop: "#b83100",
  ...
  },
  {
    ...
    warmup: 4, peak: 14, icon: "📯", category: "Clipstake",
    stroke: "#7fff00", glow: "rgba(127, 255, 0, 0.45)", stop: "#5bb800",
  ...
  },
  {
    ...
    warmup: 2, peak: 20, icon: "🎯", category: "Crosswave",
    stroke: "#ff1493", glow: "rgba(255, 20, 147, 0.45)", stop: "#b80f6a",
  ...
  },
  {
    ...
    warmup: 4, peak: 12, icon: "↔️", category: "Picksart",
    stroke: "#1e90ff", glow: "rgba(30, 144, 255, 0.45)", stop: "#1268b8",
  ...
  },
  {
    ...
    warmup: 4, peak: 14, icon: "🗜️", category: "Pearpop",
    stroke: "#ffd700", glow: "rgba(255, 215, 0, 0.45)", stop: "#b89b00",
  ...
  },
  {
    ...
    warmup: 1, peak: 2, icon: "💉", category: "Trend.io",
    stroke: "#00ced1", glow: "rgba(0, 206, 209, 0.45)", stop: "#009496",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "🎛️", category: "Insense",
    stroke: "#ff0055", glow: "rgba(255, 0, 85, 0.45)", stop: "#c0003c",
  ...
  // ── Clipping Platforms ──
  {
    ...
    warmup: 2, peak: 6, icon: "⚡", category: "Whop Clips",
  ...
  },
  {
    ...
    warmup: 3, peak: 8, icon: "🪜", category: "Clipster",
  ...
  },
  {
    ...
    warmup: 4, peak: 10, icon: "🏆", category: "Content Rewards",
  ...
  },
  {
    ...
    warmup: 6, peak: 14, icon: "🚀", category: "Clipstake",
  ...
  },
  {
    ...
    warmup: 6, peak: 16, icon: "🤖", category: "Picksart",
