  ...
  return (
    <>
      ...
      >
        ...
        <span style={{ textDecoration: "none", fontWeight: 900, background: "#fff", color: "#ea580c", padding: "3px 10px", borderRadius: 8, fontSize: 11, marginLeft: 4 }}>Claim 50% Off at YTCPM.com →</span>
      </a>
      <nav style={{
