"use client";
import { InstagramInsightsGraph } from "@/components/InstagramInsightsGraph";
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:24, maxWidth:800 }}>
      ...
      <div style={{ borderRadius:24, padding:24, background:N.bg, boxShadow:N.raised }}>
        ...
        <InstagramInsightsGraph totalViews={order.viewsTarget} durationHours={order.durationHours || 24} deliveredViews={order.viewsDelivered} platform={order.reel.platform} />
      </div>
