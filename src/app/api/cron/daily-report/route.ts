...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // 3. New Campaigns Placed in last 24h
    ...
    // 4. Campaigns COMPLETED in last 24h
    ...
    // 5. Active/Running Campaigns currently in system
    ...
    // Send Daily Report to Discord (#system-alerts)
    const reportMsg = reportHtml
    ...
    await sendDiscordAlert("system", reportMsg).catch(console.error);
