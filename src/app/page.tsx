      ...
      <section style={{ maxWidth:1100, margin:"0 auto", padding:"80px 24px 80px", textAlign:"center" }}>
        ...
        <div style={{ ...grid(wide ? "repeat(4,1fr)" : "repeat(2,1fr)", 20) }}>
          ...
          {[
            ...
            ["🔑","API Integration Mode","Connect own panels if desired"],
      ...
      <section id="faq" style={{ borderTop:`1px solid #c8d0e7`, padding:"80px 24px" }}>
        ...
        <div style={{ maxWidth:760, margin:"0 auto" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            {[
              ["Do I need to deposit funds or buy credits on YoyoSMM?","It depends on your mode. Legacy/own-API users route campaigns through SMM panels they connect using their own credentials. Wallet-mode users deposit funds directly via UPI (minimum ₹500) to pay per order according to rates set by the admin."],
              ["Which SMM panels are supported?","Any SMM panel using a standard REST API is supported. This includes Peakerr, SMMKings, JustAnotherPanel, and virtually all major SMM API providers. Simply enter your credentials in settings."],
              ...
              ["Is my SMM API key secure?","All connected SMM panel credentials and API keys are AES-256 encrypted at rest. We never log credentials in plaintext. You can revoke or swap credentials at any time from settings."],
            ].map(([q,a],i) => (
