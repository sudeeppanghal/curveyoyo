...
const PANELS = [
  "Peakerr (Flat Spikes — Outperformed)",
  "JustAnotherPanel (High Drops — Beaten)",
  "SMMKings (Bot Detection — Surpassed)",
  "SMMHeaven (Flat Delivery — Outpaced)",
  "NicePanel (Legacy API — Surpassed)",
  "FollowersGain (Artificial — Beaten)",
  "Crescitaly (Legacy Engine — Outpaced)",
  "SmmFarm (No Pacing — Beaten)",
  "SmmRaja (Flat Delivery — Outperformed)",
  "SmmPanel (Old Architecture — Beaten)",
  "GrowthPanel (High Drops — Surpassed)",
  "ViewsPanel (No Curves — Outpaced)",
  "SMMPro (Legacy Pacing — Outperformed)",
  "PanelBros (Flat Spikes — Beaten)",
  "ViewStore (Bot Flagged — Outperformed)",
];
  ...
  return (
    <div style={{ background:C.bg, color:C.text, minHeight:"100vh", fontFamily:"'Inter', -apple-system, sans-serif", overflowX:"hidden" }}>
      <style>{`
        ...
        .hero-banner-glow:hover {
          transform: translateY(-2px);
          box-shadow: 0 16px 40px rgba(0,0,0,0.6), 0 0 50px rgba(168, 85, 247, 0.25) !important;
      ...
      {/* ══ HERO ════════════════════════════════════════════ */}
      <section style={{ maxWidth:1100, margin:"0 auto", padding:"50px 24px 80px", textAlign:"center" }}>
        {/* Bullpen Full Hero Announcement Banner */}
        {announcement && (announcement.title || announcement.imageUrl) && (
          <div style={{ display: "flex", justifyContent: "center", width: "100%", marginBottom: 36 }}>
            <a
              href={announcement.targetLink || "https://app.bullpen.fi?via=spkchaudhary9211-gmail-com"}
              target="_blank"
              rel="noopener noreferrer"
              style={{ textDecoration: "none", width: "100%", maxWidth: 960, cursor: "pointer", display: "block" }}
            >
              <div
                className="hero-banner-glow"
                style={{
                  borderRadius: 24,
                  background: "linear-gradient(135deg, #18112c 0%, #0f111e 60%, #080914 100%)",
                  border: "1.5px solid rgba(168, 85, 247, 0.4)",
                  boxShadow: "0 14px 40px rgba(0,0,0,0.5), 0 0 50px rgba(168, 85, 247, 0.15)",
                  overflow: "hidden",
                  transition: "all 0.3s ease",
                  textAlign: "left",
                  position: "relative",
              ...
              >
                ...
                {announcement.imageUrl && (
                  <div style={{ width: "100%", background: "#05060f", overflow: "hidden" }}>
                    <img
                      src={announcement.imageUrl}
                      alt={announcement.title || "Bullpen Banner"}
                      style={{
                        width: "100%",
                        height: "auto",
                        maxHeight: 340,
                ...
                {/* Banner Info & Action Button Underneath */}
                <div style={{
                  padding: wide ? "18px 24px" : "16px",
                  display: "flex",
                  flexDirection: wide ? "row" : "column",
                  alignItems: "center",
                  justifyContent: "space-between",
                  gap: 16,
                  background: "linear-gradient(180deg, rgba(24, 17, 44, 0.95) 0%, rgba(10, 11, 20, 0.98) 100%)",
                  borderTop: "1px solid rgba(168, 85, 247, 0.25)",
                }}>
                  <div style={{ flex: 1, minWidth: 260 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4, flexWrap: "wrap" }}>
                      <span style={{ fontSize: 17, fontWeight: 900, color: "#ffffff", letterSpacing: "-0.3px" }}>
                        {announcement.title || "Trade Sports & Predict Markets with Bullpen"}
                      </span>
                      <span style={{
                        fontSize: 10,
                        fontWeight: 900,
                    ...
                    <p style={{ fontSize: 13, color: "#94a3b8", margin: 0, lineHeight: 1.5, fontWeight: 500 }}>
                      {announcement.description || "Trade sports and prediction markets with Bullpen. Fast & secure platform, low fees, real-time markets and rewards. Join today and start exploring."}
                    </p>
                  </div>
        ...
        <div style={{ ...grid(wide ? "repeat(4,1fr)" : "repeat(2,1fr)", 20) }}>
          {[
            ...
            ["💰","Direct Wholesale Pricing","Independent pacing layer, pay per order on-demand"],
          ].map(([icon,title,desc]) => (
      ...
      <div style={{ padding:"32px 0", background:C.bg, boxShadow:C.inset, overflow:"hidden" }}>
        <p style={{ textAlign:"center", fontSize:11, fontWeight:800, letterSpacing:"0.12em", textTransform:"uppercase", color:C.textMuted, marginBottom:18 }}>
          Independent Wholesale Architecture — Outperforming Legacy Reseller Panels
        </p>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ 
            ...
            <div style={{ flex: 1 }}>
              ...
              <a 
                href="https://t.me/TheQuantumLabs" 
                target="_blank" 
                rel="noreferrer"
                style={{ 
                  display: "inline-flex", 
