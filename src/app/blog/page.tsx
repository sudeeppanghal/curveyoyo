...
const POSTS = [
  ...
  { slug: "timing-routing-infrastructure", title: "Designing a Fail-Safe Timing Delivery Routing Infrastructure", excerpt: "How our routing nodes guarantee 99.98% delivery success rates across multiple timing paths.", date: "June 15, 2025", readTime: "7 min" },
  { slug: "why-organic-pacing-wins", title: "Why Organic Pacing Wins the Algorithm Game in 2025", excerpt: "A deep dive comparing standard panel flat delivery to timed logistic pacing curves.", date: "June 10, 2025", readTime: "8 min" },
