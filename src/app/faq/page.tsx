...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ["Which platforms are supported?", "We currently support high-retention views and organic engagement (likes, saves, comments, and shares) across Instagram, TikTok, and Facebook."],
