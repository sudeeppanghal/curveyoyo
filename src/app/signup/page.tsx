...
function formatError(err: any): string {
  ...
  return "Registration failed. Please try a different email or contact support.";
}
        ...
        {success ? (
          ...
          <>
            ...
            <div style={{ borderRadius:24, padding:"32px 28px", background:N.bg, boxShadow:N.raised }}>
              ...
              {error && (
                <div style={{ marginBottom:20, padding:"12px 16px", borderRadius:12, fontSize:13, fontWeight:600, color:"#b91c1c", background:N.bg, boxShadow:"inset 3px 3px 8px rgba(220,38,38,0.2),inset -3px -3px 8px #ffffff" }}>⚠ {typeof error === "object" ? (JSON.stringify(error) === "{}" ? "An unexpected signup error occurred." : JSON.stringify(error)) : String(error)}</div>
              )}
              ...
              <button onClick={handleGoogle} className="neo-btn-alt"
